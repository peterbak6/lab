...
function generateParadox(settings) {
  ...
  for (let attempt = 0; attempt < 240; attempt += 1) {
    ...
    if (easyLine.slope > 0 && hardLine.slope > 0 && combinedLine.slope < 0) break
  }
  return candidate
}
...
export default function SimpsonsParadox() {
  ...
  const settings = useMemo(() => ({ easyN, easyP, hardN, hardP }), [easyN, easyP, hardN, hardP])
  ...
  function restoreDefaults() {
    const alreadyDefault = easyN === DEFAULTS.easyN && easyP === DEFAULTS.easyP && hardN === DEFAULTS.hardN && hardP === DEFAULTS.hardP
    ...
    <section className="demo-page">
      ...
      <div className="demo-stage">
        ...
        <div className="chart-card simpson-chart-card">
          ...
          <div className="stone-legend">{mode === 'separate' ? <><span><i className="legend-dot simpson-easy" />Easy exam</span><span><i className="legend-dot simpson-hard" />Hard exam</span><span><i className="legend-line simpson-combined" />All students</span></> : <span><i className="legend-line simpson-combined" />All students · difficulty hidden</span>}</div>
        </div>
        ...
        <div className="readout stone-readout">
          <div className="cell"><div className="label">Easy slope</div><div className="value positive">↗ {dataset.easyLine.slope.toFixed(2)}</div></div>
          <div className="cell"><div className="label">Hard slope</div><div className="value positive">↗ {dataset.hardLine.slope.toFixed(2)}</div></div>
